...
print()
print("\tNumber of energy mines: %d" %(RESERVE_SIZE))
print("\tMean energy in each mine: %d" %(MEAN_RESERVE))
print()
print("Level of energy specified is: %s" %(energy_level))
print()
...
plt.legend()
plt.savefig("images/" + energy_level + "/mean_ages.png")
plt.show()
...
for i in range(N):
    ...
    plt.legend()
    plt.savefig("images/" + energy_level + "/num_agents_at_coop_%s.png" %(str(i * 10)))
    plt.show()
...
plt.ylabel("Number of timesteps the agents survived")
plt.legend()
plt.savefig("images/" + energy_level + "/age_distribution.png")
plt.show()
...
plt.legend()
plt.savefig("images/" + energy_level + "/energy_variation.png")
plt.show()
